...
description: Running the backend and frontend directly, without Docker.
---

# Local development (without Docker)

Docker Compose (see [Getting Started](/setup/)) is the fastest
verified path to a running instance. Run the backend and frontend directly
when you're developing on the code itself.
...
See [Contributing](/contributing) for running the test suites, lint, and the
