...
from app.api.routers import admin, ai, ai_settings, auth, extract, groups, imports, mcp, mcp_plans, mnemonics, notifications, practice, reminder_windows, reports, review, rooms, settings, words
