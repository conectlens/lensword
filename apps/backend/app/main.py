...
from app.api.routers import acquisition, admin, ai, ai_settings, auth, companion, companion_activities, companion_tasks, conversations, diagnosis, extract, graph, groups, imports, interventions, learning_paths, mcp, mcp_plans, mnemonics, notifications, observations, practice, reminder_failover, reminder_windows, reports, sync, review, rooms, scenarios, settings, weaknesses, words
