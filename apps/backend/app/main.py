...
from app.api.routers import acquisition, admin, ai, ai_settings, auth, companion, companion_activities, companion_sampling, companion_tasks, conversations, diagnosis, extract, graph, groups, imports, interventions, learning_dna, learning_paths, mcp, mcp_plans, mnemonics, notifications, observations, practice, reminder_failover, reminder_windows, reports, sync, review, rooms, scenarios, settings, weaknesses, words
...
app.include_router(companion_activities.router)
app.include_router(companion_tasks.router)
app.include_router(companion_sampling.router)
...
app.include_router(diagnosis.me_router)
app.include_router(interventions.router)
app.include_router(interventions.me_router)
