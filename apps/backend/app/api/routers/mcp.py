...
from app.application.mcp.bindings import (
    ...
    generate_exercises_for_words_handler, generate_exercises_handler, generate_mnemonic_handler,
    get_activity_result_handler,
    ...
    pause_companion_session_handler, place_word_in_room_handler, place_words_in_room_handler,
    record_answer_handler, record_context_occurrence_handler, record_context_occurrences_handler,
...
def _handlers(groups, words, sessions, exercises, provider, companion_sessions, companion_tasks, recall_settings, diagnoses, observations, companion_activities, rooms, mnemonics, edges, revisions) -> dict:
    return {
        ...
        "lensword_place_words_in_room": place_words_in_room_handler(rooms, words, groups),
        ...
        "lensword_record_context_occurrences": record_context_occurrences_handler(words, groups, observations),
